...
{
    public static readonly string URL = "https://raw.githubusercontent.com/rar006/TownOfHost-Shell/main/versions.json";
    ...
    public static bool CheckVersionsJson(bool force = false)//Task使うと起動クラッシュあるのかな? //結果が出るまでメニューを必ず待たせたい//もはやこれでいいのでは..!?!?!?
    {
        ...
        try
        {
            ...
            request.SetRequestHeader("User-Agent", "TownOfHost-Shell VersionChecker");
