...

{
...

    {
...

        {
            ...
            // GMは死亡状態として扱われるため、専用のトグルで判定する

            if (seer.Is(CustomRoles.GM))

            {

                return Options.OptionGMCanSeeDeathReason.GetBool();
...

        {
            ...
            // ダークシェリフ本人には、役職説明も通常のシェリフとして表示する。

            if (role is CustomRoles.DarkSheriff && roleClass is DarkSheriff)
