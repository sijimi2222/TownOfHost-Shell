...

    {
...

        {
            ...
            bool enabled = seer == seen
                        ...
                        || (seer.Is(CustomRoles.GM) && Options.OptionGMCanSeeRoles.GetBool())

                        || (Main.VisibleTasksCount && !seer.Is(CustomRoles.AsistingAngel) && !seer.Is(CustomRoles.GM) && !seer.IsAlive() && (!seer.IsGhostRole() || Options.GhostRoleCanSeeOtherRoles.GetBool()) && (Options.GhostCanSeeOtherRoles.GetBool() || !Options.GhostOptions.GetBool()))
...

        {
            ...
            bool enabled = seer == seen
                        ...
                        || (seer.Is(CustomRoles.GM) && Options.OptionGMCanSeeTaskProgress.GetBool())

                        || (Main.VisibleTasksCount && !seer.Is(CustomRoles.AsistingAngel) && !seer.Is(CustomRoles.GM) && !seerisAlive && (!seer.IsGhostRole() || Options.GhostRoleCanSeeOtherTasks.GetBool()) && (Options.GhostCanSeeOtherTasks.GetBool() || !Options.GhostOptions.GetBool()));
...

            {
                ...
                if (Options.OptionGMCanSeeEmergencyCount.GetBool())

                    text += $"[{PlayerState.GetByPlayerId(seen.PlayerId).NumberOfRemainingButtons}]";

            }

            else if ((Options.GhostCanSeeNumberOfButtonsOnOthers.GetBool() || !Options.GhostOptions.GetBool()) && !seerisAlive && !seer.Is(CustomRoles.AsistingAngel) && (!seer.IsGhostRole() || Options.GhostRoleCanSeeNumberOfButtonsOnOthers.GetBool()))
...

        {
            ...
            if (cr is CustomRoles.GM)
                ...
                if (Options.OptionGMCanSeeOverallTaskProgress.GetBool())
