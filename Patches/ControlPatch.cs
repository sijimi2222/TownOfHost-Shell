...

{
...

    {
...

        {
...

            {
...

                {
...

                    {
                        ...
                        CredentialsPatch.TOHhmLogo.sprite = UtilsSprite.LoadSprite("TownOfHost.Resources.TownOfHost-Shell_A.png", 300f);
            ...
            // ホスト限定: Shift + K + Enterで /cmd kf と同じキルフラッシュを実行する。

            // 左右どちらのShiftでも使えるようにし、ゲーム中だけ受け付ける。
